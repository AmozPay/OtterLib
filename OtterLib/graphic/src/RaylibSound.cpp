...
namespace Otter::Graphic::Raylib {
    ...
    RaylibSound::~RaylibSound() { UnloadSound(_sound); }

    void RaylibSound::play() { PlaySound(_sound); }

    void RaylibSound::pause() { PauseSound(_sound); }

    void RaylibSound::resume() { ResumeSound(_sound); }

    void RaylibSound::stop() { StopSound(_sound); }
    ...
    bool RaylibSound::isPlaying() { return IsSoundPlaying(_sound); }
