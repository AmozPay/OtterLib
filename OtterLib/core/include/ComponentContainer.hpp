...
namespace Otter::Core {
    ...
    class light_array {
      public:
        using value_type = C;         /**<optional component of C*/
        using container_t = std::vector<value_type>; /**<Vector of value_type*/
      using index_t = std::vector<Entity>;
        using reference_type = value_type&;             /**<value_type &*/
        using const_reference_type = value_type const&; /**<const value_type &*/
      ...
      public:
         ...
         * @param lvalue to a sparse array
         */
        light_array(light_array const& source) : _data(source._data){};
         ...
         * @warning Methode used for optimization
         */
        light_array(light_array&& source) noexcept : _data(std::move(source._data)){}; // move constructor
        ~light_array(){};
         ...
         * @details copy the data from other
         */
        light_array& operator=(light_array const& other)
        {
            if (this == &other)
                return *this;
            _data = other._data;
         ...
         * @details move the data from other
         */
        light_array& operator=(light_array&& other) noexcept
        {
            _data = std::move(other._data);
            return *this;
        };
