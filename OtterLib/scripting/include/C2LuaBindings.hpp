...
#define CLB_STRING_GSETTER(componentType, memberName)                                                                  \
...
#define CLB_INT_GSETTER(componentType, memberName)                                                                     \
    int set_##memberName(lua_State* L)                                                                                 \
    {                                                                                                                  \
        Otter::Scripting::LuaContext ctx(L);                                                                           \
        Otter::Core::Orchestrator* orchestrator =                                                                      \
...
#define CLB_NUMBER_GSETTER(componentType, memberName)                                                                  \
    int set_##memberName(lua_State* L)                                                                                 \
    {                                                                                                                  \
        Otter::Scripting::LuaContext ctx(L);                                                                           \
        Otter::Core::Orchestrator* orchestrator =                                                                      \
...
#define CLB_BOOL_GSETTER(componentType, memberName)                                                                    \
    int set_##memberName(lua_State* L)                                                                                 \
    {                                                                                                                  \
        Otter::Scripting::LuaContext ctx(L);                                                                           \
        Otter::Core::Orchestrator* orchestrator =                                                                      \
...
#define CLB_VECTOR2_GSETTER(componentType, memberName)                                                                 \
    int set_##memberName(lua_State* L)                                                                                 \
    {                                                                                                                  \
        Otter::Scripting::LuaContext ctx(L);                                                                           \
        Otter::Core::Orchestrator* orchestrator =                                                                      \
...
namespace Otter::Scripting::Bindings::Templates {
    ...
    // _luaContext.registerFunction("__removeComponent.MyComponent",
    // Otter::Scripting::Bindings::Templates::removeComponent<MyComponent>);
    template <typename T>
